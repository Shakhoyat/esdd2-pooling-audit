#!/usr/bin/env python3
"""Section 4.2: the declared constants, the gates, and the full constant sweep."""
...
print(f"  c = 0                     {g['c0']:.4f}")
print(f"  c = 0.5, and oracle gate  {g['c05']:.4f}   (the label-free floor)")
print(f"  gate from original score  {g['free_gate']:.4f}")
print(f"  label-free fixed point    {g['prop3_floor']:.4f}   w_a = {g['wa']:.4f}")
